...
- каждый пункт перечня имеет признак завершённости, проверяемый независимо от заявления агента;
...
Источники: `references/source-book/chapter5.md:82`, `references/source-book/chapter5.md:233`, `references/source-book/chapter8.md:181`.
...
**Порядок проверки — сверху вниз, остановка на первом сработавшем:**
...
Источники: `references/source-book/chapter7.md:27`, `references/source-book/chapter7.md:305`, `references/source-book/chapter7.md:447`, `references/source-book/chapter8.md:23`.
...
- enforcement реализован вне модели: текст в системном промпте не является механизмом защиты.
