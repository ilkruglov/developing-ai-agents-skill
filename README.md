...
26 сценариев, слепая парная оценка версии 0.5.1 против 0.4.0. Прогон
использовался для поиска регрессий при переносе материала из ядра в
справочные слои; найденные расхождения устранены в 0.5.1.

Сырые оценки, метод и ограничения прогона —
